...
namespace FuetEngine
{
	...
	*/
	public class CFEMenuButton
	{
		...
		public void SetNeighbour(CFEMenuButton _oButton, EFEButtonNeigh _eNeigh)
		{
			m_oNeighs[(int)_eNeigh] = _oButton;
		}

		/// Retrieves the given neighbour of this button
		public CFEMenuButton oGetNeighbour(EFEButtonNeigh _eNeigh)
		{
			return (m_oNeighs[(int)_eNeigh]);
		}
		//-----------------------------------------------------------------------------
